...
hoja de chequeo F7-SETCS-ELE-40-L1-01 COPIA 4
    <!-- -------------- F7-SETCS-ELE-40-L1-01-1-4  INDEX Y REVERSO  -------------------->
                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                            @if ($registro->turno == '1' &&
                                $registro->documentoid == 'F7-SETCS-ELE-40-L1-01-1-4' &&
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-01-1-4" && $reverso->turno == "1")
            <tr>
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-01 COPIA 5
    <!-- -------------- F7-SETCS-ELE-40-L1-01-1-5  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                            @if ($registro->turno == '1' &&
                                $registro->documentoid == 'F7-SETCS-ELE-40-L1-01-1-5' &&
                                $registro->partetabla == 'ARRIBA' &&
                                $registro->tipo == 'cumple')
                                <tr>
                                    <td class="fijar">{{ $registro->criterio }}</td>
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-01-1-5" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    <!-- -------------- F7-SETCS-ELE-40-L1-02-1-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-02-1-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    <!-- -------------- F7-SETCS-ELE-40-L1-02-1-2  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-02-1-2" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    <!-- -------------- F7-SETCS-ELE-40-L1-02-1-3  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '1' &&
                        $registro->documentoid == 'F7-SETCS-ELE-40-L1-02-1-3' &&
                        $registro->partetabla == '6:00' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-02-1-3" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
