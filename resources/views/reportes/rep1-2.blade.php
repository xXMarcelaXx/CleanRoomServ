...
hoja de chequeo F7-SETCS-ELE-20-L1-03
    <!-- -------------- F7-SETCS-ELE-20-L1-03-1  INDEX Y REVERSO  -------------------->
    ...
    <!-- -------------- F7-SETCS-ELE-40-L1-01-1-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-01-1-2" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    <!-- -------------- F7-SETCS-ELE-40-L1-01-1-3  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-01" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
