...
hoja de chequeo F7-SETCS-ELE-60-L1-06-4
<!-- -------------- F7-SETCS-ELE-60-L1-06-4  INDEX Y REVERSO  -------------------->
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-4' &&
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-4" && $reverso->turno == "2")
            <tr>
...
hoja de chequeo F7-SETCS-ELE-60-L1-06-5
<!-- -------------- F7-SETCS-ELE-60-L1-06-5  INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-5' &&
                        $registro->partetabla == 'INICIO' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-5" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-60-L1-06-6
<!-- -------------- F7-SETCS-ELE-60-L1-06-6  INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-6' &&
                        $registro->partetabla == 'INICIO' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-6" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-60-L1-06-7
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-7' &&
                        $registro->partetabla == 'INICIO' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-7" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-60-L1-07-1
<!-- -------------- F7-SETCS-ELE-60-L1-07-1  INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-60-L1-07')
                        <tr>
                            <th rowspan="2" colspan="3" style="text-align: end">Titulo</th>
                            <th colspan="4" style="text-align: center">{{ $datoshoja->titulo }}</th>
                            <th rowspan="2" colspan="1" style="text-align: end">DocumentoID</th>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-07-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
