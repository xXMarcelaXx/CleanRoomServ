...
<table class="table table-success table-bordered table-striped mt-4">
    ...
    <tbody>
        @foreach ($reversos as $reverso)
        @if ($reverso->documentoid == "F7-SETCS-ELE-20-L1-01-3-1" && $reverso->turno == "1")
        <tr>
            <td>{{$reverso->fechahora}}</td>
            <td>{{$reverso->falla}}</td>
            <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-20-L1-01 COPIA 4
...
<table class="table table-success table-bordered table-striped mt-4">
    ...
    <tbody>
        @foreach ($reversos as $reverso)
        @if ($reverso->documentoid == "F7-SETCS-ELE-20-L1-01-4-1" && $reverso->turno == "1")
        <tr>
            <td>{{$reverso->fechahora}}</td>
            <td>{{$reverso->falla}}</td>
            <td>{{$reverso->proceso}}</td>
