...
hoja de chequeo F7-SETCS-ELE-60-L1-06-1-2-2
<!-- -------------- F7-SETCS-ELE-60-L1-06-1-2-2  INDEX Y REVERSO  -------------------->
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-1-2-2" && $reverso->turno == "3")
            <tr>
...
hoja de chequeo F7-SETCS-ELE-60-L1-06-1-3-2
<!-- -------------- F7-SETCS-ELE-60-L1-06-1-3-2  INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '3' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-1-3-2' &&
                        $registro->partetabla == 'INICIO' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-1-3-2" && $reverso->turno == "3")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-60-L1-06-1-4-2
<!-- -------------- F7-SETCS-ELE-60-L1-06-1-4-2  INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '3' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-1-4-2' &&
                        $registro->partetabla == 'INICIO' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
                            ...
                            @role('Admin')
                            <td>
                                <form action="{{route('F7-SETCS-ELE-60-L1-06-4T3.destroy',$registro->id)}}" method="POST">
                                <a href="F7-SETCS-ELE-60-L1-06-4T3/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                @csrf
                                @method('DELETE')
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-1-4-2" && $reverso->turno == "3")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-1-5-2" && $reverso->turno == "3")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-60-L1-06-1-6-2
<!-- -------------- F7-SETCS-ELE-60-L1-06-1-6-2 INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '3' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-1-6-2' &&
                        $registro->partetabla == 'INICIO' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
