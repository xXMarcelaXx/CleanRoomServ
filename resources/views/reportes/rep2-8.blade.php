...
hoja de chequeo F7-SETCS-ELE-100-L1-01-1-1
<!-- -------------- F7-SETCS-ELE-100-L1-01-1-1  INDEX Y REVERSO  -------------------->
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-01-1-1" && $reverso->turno == "2")
            <tr>
...
hoja de chequeo F7-SETCS-ELE-100-L1-01-1-2
<!-- -------------- F7-SETCS-ELE-100-L1-01-1-2 INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-SETCS-ELE-100-L1-01-1-2' &&
                        $registro->partetabla == 'ARRIBA' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-01-1-2" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-SETCS-ELE-100-L1-01-1-3
<!-- -------------- F7-SETCS-ELE-100-L1-01-1-3  INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-SETCS-ELE-100-L1-01-1-3' &&
                        $registro->partetabla == 'ARRIBA' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-01-1-3" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-02-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
