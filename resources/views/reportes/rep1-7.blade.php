...
hoja de chequeo F7-SETCS-ELE-60-L1-08 
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-08-1" && $reverso->turno == "1")
            <tr>
    ...
    hoja de chequeo F7-SETCS-ELE-100-L1-01 
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-01-1-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    hoja de chequeo F7-SETCS-ELE-100-L1-01 COPIA 2
    <!-- -------------- F7-SETCS-ELE-100-L1-01-2-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '1' &&
                        $registro->documentoid == 'F7-SETCS-ELE-100-L1-01-2-1' &&
                        $registro->partetabla == 'ARRIBA' &&
                        $registro->tipo == 'cumple')
                        <tr>
                            <td>{{ $registro->criterio }}</td>
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-01-2-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    hoja de chequeo F7-SETCS-ELE-100-L1-01 COPIA 3
    <!-- -------------- F7-SETCS-ELE-100-L1-01-3-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-01-3-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    hoja de chequeo F7-SETCS-ELE-100-L1-02
