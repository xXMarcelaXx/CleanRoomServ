...
hoja de chequeo F7-TPM-ELE-60-L1-01-6
<!-- -------------- F7-TPM-ELE-60-L1-01-6  INDEX Y REVERSO  -------------------->
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-TPM-ELE-60-L1-01-6' &&
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-TPM-ELE-60-L1-01-6" && $reverso->turno == "2")
            <tr>
...
hoja de chequeo F7-TPM-ELE-60-L1-01-7
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-TPM-ELE-60-L1-01-7' &&
                        $registro->partetabla == 'ARRIBA' &&
                        $registro->tipo == 'cumple' &&
                        $registro->mes == $datoshoja->mes &&
                        $registro->año == $datoshoja->año)
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-TPM-ELE-60-L1-01-7" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-TPM-ELE-100-L1-01-1
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-TPM-ELE-100-L1-01-1" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-TPM-ELE-100-L1-01-2
<!-- -------------- F7-TPM-ELE-100-L1-01-2 INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-TPM-ELE-100-L1-01-2' &&
                        $registro->partetabla == 'ARRIBA' &&
                        $registro->tipo == 'cumple' &&
                        $registro->mes == $datoshoja->mes &&
                        $registro->año == $datoshoja->año)
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-TPM-ELE-100-L1-01-2" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
...
hoja de chequeo F7-TPM-ELE-100-L1-01-3
<!-- -------------- F7-TPM-ELE-100-L1-01-3 INDEX Y REVERSO  -------------------->
<div style="page-break-after:always;">
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @foreach ($registros as $registro)
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-TPM-ELE-100-L1-01-3' &&
                        $registro->partetabla == 'ARRIBA' &&
                        $registro->tipo == 'cumple' &&
                        $registro->mes == $datoshoja->mes &&
                        $registro->año == $datoshoja->año)
...
<div style="page-break-after:always;">
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-TPM-ELE-100-L1-01-3" && $reverso->turno == "2")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
