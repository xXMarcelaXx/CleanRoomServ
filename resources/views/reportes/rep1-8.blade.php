...
hoja de chequeo F7-SETCS-ELE-100-L1-03 
    <!-- -------------- F7-SETCS-ELE-100-L1-03-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-100-L1-03')
                        <tr>
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            ...
            @if ($reverso->documentoid == "F7-SETCS-ELE-100-L1-03-1" && $reverso->turno == "1")
            <tr>
    ...
    hoja de chequeo F7-SETCS-ELE-103-L1-01 
    <!-- -------------- F7-SETCS-ELE-103-L1-01-1 INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-103-L1-03')
                        <tr>
                            <th rowspan="2" colspan="3" style="text-align: end">Titulo</th>
                            <th colspan="4" style="text-align: center">{{ $datoshoja->titulo }}</th>
                            <th rowspan="2" colspan="1" style="text-align: end">DocumentoID</th>
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-103-L1-01-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    hoja de chequeo F7-SETCS-ELE-107-L1-01
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-107-L1-01-1-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    hoja de chequeo F7-SETCS-ELE-107-L1-01 COPIA 2
    <!-- -------------- F7-SETCS-ELE-107-L1-01-2-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-107-L1-01-2-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
    ...
    hoja de chequeo F7-SETCS-ELE-107-L1-01 COPIA 3
    <!-- -------------- F7-SETCS-ELE-107-L1-01-3-1  INDEX Y REVERSO  -------------------->
    <div class="table-responsive">
        <table class="table table-success table-bordered">
            <thead>
                @foreach ($datoshojas as $datoshoja)
    ...
    <table class="table table-success table-bordered table-striped mt-4">
        ...
        <tbody>
            @foreach ($reversos as $reverso)
            @if ($reverso->documentoid == "F7-SETCS-ELE-107-L1-01-3-1" && $reverso->turno == "1")
            <tr>
                <td>{{$reverso->fechahora}}</td>
                <td>{{$reverso->falla}}</td>
                <td>{{$reverso->proceso}}</td>
