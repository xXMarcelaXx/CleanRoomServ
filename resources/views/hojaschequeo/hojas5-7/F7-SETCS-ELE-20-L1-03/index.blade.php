                ...
                @foreach ($datoshojas as $datoshoja)
                    ...
                    $datoshoja->area == 'Cuarto Limpio 1')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS2031/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
...
<td class="fijar">{{ $registro->criterio }}</td>
                                    ...
                                    @role('Admin')
                                    <td>
                                        <form action="{{route('F7-SETCS-ELE-20-L1-03-1.destroy',$registro->id)}}" method="POST">
                                        <a href="F7-SETCS-ELE-20-L1-03-1/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                        @csrf
                                        @method('DELETE')
