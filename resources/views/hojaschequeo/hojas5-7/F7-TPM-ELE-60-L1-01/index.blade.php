                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-TPM-ELE-60-L1-01')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2TPM6011/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
...
<td class="fijar">{{ $registro->criterio }}</td>
                                    ...
                                    @role('Admin')
                                    <td>
                                        <form action="{{route('F7-TPM-ELE-60-L1-01-1.destroy',$registro->id)}}" method="POST">
                                        <a href="F7-TPM-ELE-60-L1-01-1/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                        @csrf
                                        @method('DELETE')
                    ...
                    <a href="{{route('checkTPM6011')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-TPM-ELE-60-L1-01-1/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintTPM6011')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoTPM6011" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
