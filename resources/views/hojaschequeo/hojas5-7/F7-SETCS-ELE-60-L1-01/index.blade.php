                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-60-L1-01' )
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS606113H1T1/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole
                            </th>
                            <th colspan="30"></th>
                        </tr>
        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                ...
                @if ($registro->turno == '1' &&
                    ...
                    <a href="{{route('checkSETCS606113H1T1')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-60-L1-01-T1/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS606113H1T1')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS606113H1T1" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
