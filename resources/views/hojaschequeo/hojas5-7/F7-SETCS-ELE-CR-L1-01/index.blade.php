...
<td class="fijar">{{ $registro->criterio }}</td>
                    ...
                    <a href="{{route('check')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-CR-L1-01-57/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprint')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reverso" class="btn btn-secondary" id="btnIndex4">Reverso</a>    
