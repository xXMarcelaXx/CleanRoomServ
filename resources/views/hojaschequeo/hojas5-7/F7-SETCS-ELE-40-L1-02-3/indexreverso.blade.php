...
.fijar {
  ...
  z-index: 1;
    ...
    <body id="vistas">
        ...
        @endauth
                    <a href="F7-SETCS-ELE-40-L1-02-1-3" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS40213.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS40213/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS40213/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS40213')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>