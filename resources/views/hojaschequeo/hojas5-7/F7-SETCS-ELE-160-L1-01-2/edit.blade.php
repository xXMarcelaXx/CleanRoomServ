...
<form action="/F7-SETCS-ELE-160-L1-01-2/{{$registro->id}}"id="loginreg" method="POST">
    @csrf
    @method('PUT')
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.0001" name="valor1" id="valor1" class="form-control" tabindex="1" value="{{$registro->valor1}}">
    </div>
    <div class="mb-3">
        <label for="" id=txt1 class="form-label">Valor2</label>
        <input type="number" step="0.0001" name="valor2" id="valor2" class="form-control" tabindex="1" value="{{$registro->valor2}}">
    </div>
    @endif
    <div>
