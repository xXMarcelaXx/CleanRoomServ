...
<form action="/F7-SETCS-ELE-160-L1-01-2"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1" hidden value="F7-SETCS-ELE-160-L1-01-2">
    </div>
    <div class="mb-3">
        <label for="" id="txt1" class="form-label">Parte</label>
        <select id="partetabla" name="partetabla" class="form-control" tabindex="1">
            <option value="ARRIBA">A LAS 07:00 HRS</option>
            <option value="#1">ANTES DE IMPRIMIR #1</option>
            <option value="ABAJO">A LAS 19:00 HRS</option>
            <option value="#2">ANTES DE IMPRIMIR #2</option>
        </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.0001" name="valor1" id="valor1" class="form-control" tabindex="1">
    </div>
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-160-L1-01-2" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
