    ...
    <body id="vistas">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        @endauth
                    <a href="F7-TPM-ELE-140-L1-01-2" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-TPM-ELE-140-L1-01-2" && $reverso->turno == "1")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoTPM14012.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoTPM14012/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoTPM14012/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoTPM14012')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>