...
<form action="/F7-TPM-ELE-120-L1-01-2-1"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-TPM-ELE-120-L1-01-2-1" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
