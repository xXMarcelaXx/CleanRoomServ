    ...
    <div class="table-responsive">
        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                ...
                @foreach ($registros as $registro)
                    @if ($registro->turno == '1' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-02-5-1-1' &&
                ...
                @foreach ($registros as $registro)
                    ...
                    <a href="{{route('checkSETCS606511')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-60-L1-06-5-1-1/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS606511')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS606511" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
