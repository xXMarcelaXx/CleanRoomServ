                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-60-L1-06-2')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS606521/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        @if ($registro->turno == '1' &&
                        $registro->documentoid == 'F7-SETCS-ELE-60-L1-06-5-2-1' &&
                        ...
                        <tr>
                            ...
                            @role('Admin')
                            <td>
                                <form action="{{route('F7-SETCS-ELE-60-L1-06-5-2-1.destroy',$registro->id)}}" method="POST">
                                <a href="F7-SETCS-ELE-60-L1-06-5-2-1/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                @csrf
                                @method('DELETE')
                    ...
                    <a href="{{route('checkSETCS606521')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-60-L1-06-5-2-1/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS606521')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS606521" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
