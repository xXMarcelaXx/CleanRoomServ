    ...
    <body id="vistas">
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-SETCS-ELE-60-L1-06-5-2-1" && $reverso->turno == "1" )
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS606521.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS606521/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS606521/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS606521')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>