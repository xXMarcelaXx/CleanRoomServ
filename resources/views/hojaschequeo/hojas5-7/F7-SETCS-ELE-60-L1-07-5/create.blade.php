...
<form action="/F7-SETCS-ELE-60-L1-07-5T1"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1" hidden value="F7-SETCS-ELE-60-L1-07-5">
    </div>
    <div class="mb-3">
        <label for="" id="txt1" class="form-label">Parte</label>
        <select id="partetabla" name="partetabla" class="form-control" tabindex="1">
            <option value="A LAS 07:00 HRS">A LAS 07:00 HRS</option>
            <option value="ANTES DE IMPRIMIR">ANTES DE IMPRIMIR</option>
            <option value="A LAS 19:00 HRS">A LAS 19:00 HRS</option>
            <option value="ANTES DE IMPRIMIR#2">ANTES DE IMPRIMIR #2</option>
        </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.001" name="valor1" id="valor1" class="form-control" tabindex="1">
    </div>
    <div class="mb-3">
        <label for="" id=txt1 class="form-label">Valor2</label>
        <input type="number" step="0.001" name="valor2" id="valor2" class="form-control" tabindex="1">
    </div>
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-60-L1-07-5T1" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
