    ...
    <body id="vistas">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        @endauth
                    <a href="F7-TPM-ELE-60-L1-01-3" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-TPM-ELE-60-L1-01-3" && $reverso->turno == "1")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoTPM6013.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoTPM6013/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoTPM6013/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoTPM6013')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>