                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-100-L1-02')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS10021/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
...
<td class="fijar">{{ $registro->criterio }}</td>
                                    ...
                                    @role('Admin')
                                    <td>
                                        <form action="{{route('F7-SETCS-ELE-100-L1-02-1.destroy',$registro->id)}}" method="POST">
...
<td class="fijar">{{ $registro->criterio }}</td>
                    ...
                    <a href="{{route('checkSETCS10021')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-100-L1-02-1/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS10021')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS10021" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
