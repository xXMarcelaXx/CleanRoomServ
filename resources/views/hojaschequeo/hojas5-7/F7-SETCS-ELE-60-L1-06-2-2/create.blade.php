...
<form action="/F7-SETCS-ELE-60-L1-06-2-2-1"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1" hidden value="F7-SETCS-ELE-60-L1-06-2-2-1">
    </div>
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-60-L1-06-2-2-1" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
