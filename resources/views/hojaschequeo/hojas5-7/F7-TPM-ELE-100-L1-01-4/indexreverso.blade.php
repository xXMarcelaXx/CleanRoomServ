    ...
    <body id="vistas">
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-TPM-ELE-100-L1-01-4" && $reverso->turno == "1")
                <tr>
        ...
        <a href="/reversoTPM10014/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoTPM10014')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>