                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-TPM-ELE-40-L1-01')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2TPM4012/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
                ...
                <thead>
                    ...
                    @foreach ($registros as $registro)
                        ...
                        <tr>
                            ...
                            @role('Admin')
                            <td>
                                <form action="{{route('F7-TPM-ELE-40-L1-01-2.destroy',$registro->id)}}" method="POST">
                                <a href="F7-TPM-ELE-40-L1-01-2/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                @csrf
                                @method('DELETE')
                 ...
                 @endforeach
                    ...
                    <a href="{{route('checkTPM4012')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-TPM-ELE-40-L1-01-2/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintTPM4012')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoTPM4012" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
