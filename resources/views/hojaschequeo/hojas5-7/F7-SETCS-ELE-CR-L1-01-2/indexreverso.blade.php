    ...
    <body id="vistas">
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <a href="F7-SETCS-ELE-CR-L1-01-57-2" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-SETCS-ELE-CR-L1-01-57-2" && $reverso->turno == "1")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reverso2.destroy',$reverso->id)}}" method="POST">
                        <a href="reverso2/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reverso2/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfprintReversoF7SETCSELECRL1012')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>