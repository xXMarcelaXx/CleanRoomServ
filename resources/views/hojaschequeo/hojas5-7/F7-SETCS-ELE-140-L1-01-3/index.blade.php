                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-140-L1-01')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS140131/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    @foreach ($registros as $registro)
                        ...
                        <tr>
                            ...
                            @role('Admin')
                            <td>
                                <form action="{{route('F7-SETCS-ELE-140-L1-01-3-1.destroy',$registro->id)}}" method="POST">
                                <a href="F7-SETCS-ELE-140-L1-01-3-1/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                @csrf
                                @method('DELETE')
                ...
                @endforeach
                    ...
                    <a href="{{route('checkSETCS140131')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-140-L1-01-3-1/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS140131')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS140131" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>