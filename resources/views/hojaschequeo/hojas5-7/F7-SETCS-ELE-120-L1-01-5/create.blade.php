...
<form action="/F7-SETCS-ELE-120-L1-01-5-1"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-120-L1-01-5-1" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
