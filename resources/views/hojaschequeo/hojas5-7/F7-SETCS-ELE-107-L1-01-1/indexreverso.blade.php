...
.fijar {
  ...
  z-index: 1;
    ...
    <body id="vistas">
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS107111.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS107111/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS107111/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS107111')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>