    ...
    <body id="vistas">
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light">
                ...
                @endauth
                    <a href="F7-SETCS-ELE-40-L1-01-6" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-SETCS-ELE-40-L1-01-6" && $reverso->turno == "1")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS40116.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS40116/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS40116/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS40116')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>