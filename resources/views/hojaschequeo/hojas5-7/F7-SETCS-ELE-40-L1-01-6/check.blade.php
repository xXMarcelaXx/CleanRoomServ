    ...
    <div>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                @endauth
                <a href="F7-SETCS-ELE-40-L1-01-1-6" class="btn btn-info" style="color: white">Volver</a>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        <form action="{{route('finalcheckSETCS40116',$registro->id)}}" method="POST">                            
                            @if ($registro->turno == '1' &&
...
<td class="fijar">{{ $registro->criterio }}</td>
                        ...
                        @foreach ($registros as $key=>$registro)
                        <form action="{{route('finalcheckSETCS40115',$registro->id)}}" method="POST">                            
                            @if ($registro->turno == '1' &&
                                $registro->documentoid == 'F7-SETCS-ELE-40-L1-01-1-6' &&
