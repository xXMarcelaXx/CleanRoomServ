...
<td class="fijar">{{ $registro->criterio }}</td>
    ...
    <td class="fijar">{{ $registro->criterio }}</td>
                    ...
                    <a href="{{route('checkSETCS6083')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-60-L1-08-T3/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS6083')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS6083" class="btn btn-secondary">Reverso</a>                    
</body>
</html>
