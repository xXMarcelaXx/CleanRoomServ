...
<body id="vistas">
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            ...
            <h3>Editar Reverso</h3> 
            <div>                               
            @auth
            <a href="" class="btn btn-info" style="color: white">IBM: {{auth()->user()->name ?? 
            auth()->user()->IBM}} \ {{auth()->user()->name ?? auth()->user()->firstname}}</a>               
            <a href="/reversoT3" class="btn btn-info" style="color: white">Volver</a>
            <a href="logout" class="btn" id="b3">Cerrar sesion</a> 
            @endauth                       
            </div>
        </div>
    </nav>
    <form action="/reversoT3/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1"
                    hidden value="F7-SETCS-ELE-CR-L1-01-57">
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="/reversoT3" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
