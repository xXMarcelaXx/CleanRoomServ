...
.fijar {
  ...
  z-index: 1;
    ...
    <body id="vistas">
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    @endauth
                    <a href="F7-SETCS-ELE-140-L1-01-3T3" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS140113C3.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS140113C3/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS140113C3/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS140113C3')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>