...
<form action="/F7-TPM-ELE-107-L1-01-3T3"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-TPM-ELE-107-L1-01-3T3" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
