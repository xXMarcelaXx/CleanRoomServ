...
<body id="vistas">
    ...
    <form action="/reversoSETCS40223C2/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            ...
            <div>
                ...
                <a href="/reversoSETCS40223C2" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
