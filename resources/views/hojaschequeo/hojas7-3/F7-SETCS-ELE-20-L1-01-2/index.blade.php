                ...
                @foreach ($datoshojas as $datoshoja)
                    ...
                    $datoshoja->area == 'Cuarto Limpio 1')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS20T3C2/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
...
<td class="fijar">{{ $registro->criterio }}</td>
                                    ...
                                    @role('Admin')
                                    <td>
                                        <form action="{{route('F7-SETCS-ELE-20-L1-01-2T3.destroy',$registro->id)}}" method="POST">
                                        <a href="F7-SETCS-ELE-20-L1-01-2T3/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                        @csrf
                                        @method('DELETE')
...
<td class="fijar">{{ $registro->criterio }}</td>
                    ...
                    <a href="{{route('checkSETCS20T3C2')}}" class="btn btn-primary">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-20-L1-01-2T3/create" class="btn btn-success">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS20T3C2')}}" class="btn btn-danger">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS20T3C2" class="btn btn-secondary">Reverso</a>                    
</body>
</html>
