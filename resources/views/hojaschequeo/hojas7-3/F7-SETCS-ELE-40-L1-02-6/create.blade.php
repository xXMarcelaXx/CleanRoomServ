...
<form action="/F7-SETCS-ELE-40-L1-02-6T3"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-40-L1-02-6T3" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
