...
<body id="vistas">
    ...
    <form action="/reversoTPM10711T3/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1"
                    hidden value="F7-TPM-ELE-107-L1-01-1">
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="/reversoTPM10711T3" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
