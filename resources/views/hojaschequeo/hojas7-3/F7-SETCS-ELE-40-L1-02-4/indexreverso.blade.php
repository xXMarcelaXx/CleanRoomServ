...
.fijar {
  ...
  z-index: 1;
    ...
    <body id="vistas">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        @endauth
                    <a href="F7-SETCS-ELE-40-L1-02-4T3" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS40223C4.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS40223C4/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS40223C4/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS40223C4')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>