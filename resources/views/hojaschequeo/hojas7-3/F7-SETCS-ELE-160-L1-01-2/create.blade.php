...
<form action="/F7-SETCS-ELE-160-L1-01-2T3"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select id="partetabla" name="partetabla" class="form-control" tabindex="1">
            <option value="ARRIBA">19:00 HRS</option>
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-160-L1-01-2T3" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
