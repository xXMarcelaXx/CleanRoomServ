...
<body id="vistas">
    ...
    <form action="/reversoSETCS16013C2/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1"
                    hidden value="F7-SETCS-ELE-160-L1-01-2">
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="/reversoSETCS16013C2" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
