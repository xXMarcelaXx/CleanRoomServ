...
<body id="vistas">
    ...
    <form action="/reversoSETCS40223C8/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1"
                    hidden value="F7-SETCS-ELE-40-L1-02-2-8">
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="/reversoSETCS40223C8" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
