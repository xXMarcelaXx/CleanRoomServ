    ...
    <body id="vistas">
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light">
                ...
                @endauth
                    <a href="F7-SETCS-ELE-60-L1-06-T3" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS606113.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS606113/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS606113/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS606113')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>