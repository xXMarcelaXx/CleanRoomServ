...
<head>
    ...
    <title>F7-SETCS-ELE-40-L1-02-4T2</title>
                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-40-L1-02')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS40221C4/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @role('Admin')
                            <td>
                                <form action="{{route('F7-SETCS-ELE-40-L1-02-4T2.destroy',$registro->id)}}" method="POST">
                                <a href="F7-SETCS-ELE-40-L1-02-4T2/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                @csrf
                                @method('DELETE')
                ...
                @foreach ($registros as $registro)
                    ...
                    <a href="{{route('checkSETCS40221C4')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-40-L1-02-4T2/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS40221C4')}}" class="btn btn-danger"id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS40221C4" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
