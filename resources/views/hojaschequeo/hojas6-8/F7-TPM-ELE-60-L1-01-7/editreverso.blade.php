...
<body id="vistas">
    ...
    <form action="/reversoTPM6017T2/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="/reversoTPM6017T2" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
