...
.fijar {
  ...
  z-index: 1;
    ...
    <body id="vistas">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        @endauth
                    <a href="F7-TPM-ELE-60-L1-01-7T2" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoTPM6017T2.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoTPM6017T2/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoTPM6017T2/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoTPM6017T2')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>