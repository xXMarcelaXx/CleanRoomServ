...
<head>
    ...
    <title>F7-TPM-ELE-160-L1-01</title>
    ...
    <div>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                @endauth
                <a href="F7-TPM-ELE-160-L1-01-2T2" class="btn btn-info" style="color: white">Volver</a>
            ...
            <table class="table table-success table-bordered">
                <thead>
                    ...
                    <tbody>
                        ...
                        <form action="{{route('finalcheckTPM16012T2',$registro->id)}}" method="POST">                            
                            @if ($registro->turno == '2' &&
                                $registro->documentoid == 'F7-TPM-ELE-160-L1-01-2' &&
...
<td class="fijar">{{ $registro->criterio }}</td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d1]" id="d1" tabindex="1" value="{{$registro->d1}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d2]" id="d2" tabindex="1" value="{{$registro->d2}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d3]" id="d3" tabindex="1" value="{{$registro->d3}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d4]" id="d4" tabindex="1" value="{{$registro->d4}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d5]" id="d5" tabindex="1" value="{{$registro->d5}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d6]" id="d6" tabindex="1" value="{{$registro->d6}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d7]" id="d7" tabindex="1" value="{{$registro->d7}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d8]" id="d8" tabindex="1" value="{{$registro->d8}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d9]" id="d9" tabindex="1" value="{{$registro->d9}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d10]" id="d10" tabindex="1" value="{{$registro->d10}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d11]" id="d11" tabindex="1" value="{{$registro->d11}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d12]" id="d12" tabindex="1" value="{{$registro->d12}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d13]" id="d13" tabindex="1" value="{{$registro->d13}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d14]" id="d14" tabindex="1" value="{{$registro->d14}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d15]" id="d15" tabindex="1" value="{{$registro->d15}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d16]" id="d16" tabindex="1" value="{{$registro->d16}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d17]" id="d17" tabindex="1" value="{{$registro->d17}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d18]" id="d18" tabindex="1" value="{{$registro->d18}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d19]" id="d19" tabindex="1" value="{{$registro->d19}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d20]" id="d20" tabindex="1" value="{{$registro->d20}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d21]" id="d21" tabindex="1" value="{{$registro->d21}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d22]" id="d22" tabindex="1" value="{{$registro->d22}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d23]" id="d23" tabindex="1" value="{{$registro->d23}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d24]" id="d24" tabindex="1" value="{{$registro->d24}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d25]" id="d25" tabindex="1" value="{{$registro->d25}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d26]" id="d26" tabindex="1" value="{{$registro->d26}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d27]" id="d27" tabindex="1" value="{{$registro->d27}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d28]" id="d28" tabindex="1" value="{{$registro->d28}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d29]" id="d29" tabindex="1" value="{{$registro->d29}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d30]" id="d30" tabindex="1" value="{{$registro->d30}}">
                                    </td>
                                    <td>
                                        <input type="" step="0.01" size='15' name="registro[{{$key}}][d31]" id="d31" tabindex="1" value="{{$registro->d31}}">
                                    </td>
                                </tr>
                            @endif
                            @if ($registro->turno == '2' &&
...
<td class="fijar">{{ $registro->criterio }}</td>
                        ...
                        @foreach ($registros as $key=>$registro)                          
                        @if ($registro->turno == '2' &&
                        $registro->documentoid == 'F7-TPM-ELE-120-L1-01-2' &&
