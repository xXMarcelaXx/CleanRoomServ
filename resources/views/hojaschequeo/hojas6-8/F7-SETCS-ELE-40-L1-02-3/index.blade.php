...
<head>
    ...
    <title>F7-SETCS-ELE-40-L1-02-3T2</title>
        ...
        <div class="table-responsive" align="center">
            <table class="table table-success table-bordered">
                ...
                @foreach ($registros as $registro)
                    ...
                    <a href="{{route('checkSETCS40221C3')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-40-L1-02-3T2/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS40221C3')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS40221C3" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
