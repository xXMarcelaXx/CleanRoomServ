...
<form action="/F7-TPM-ELE-40-L1-01-1T2"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1" hidden value="F7-TPM-ELE-40-L1-01-1">
    </div>
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-TPM-ELE-40-L1-01-1T2" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
