                ...
                @foreach ($datoshojas as $datoshoja)
                    @if ($datoshoja->documentoid == 'F7-SETCS-ELE-40-L1-01')
                        ...
                        <tr>
                            ...
                            <th>
                            @role('Admin')
                            <a href="/edit2SETCS40123C5/{{$datoshoja->id}}" class="btn btn-warning">Editar</a>
                            @endrole                                
                            </th>
                            <th colspan="30"></th>
                        </tr>
...
<td class="fijar">{{ $registro->criterio }}</td>
                                    ...
                                    @role('Admin')
                                    <td>
                                        <form action="{{route('F7-SETCS-ELE-40-L1-01-5T2.destroy',$registro->id)}}" method="POST">
                                        <a href="F7-SETCS-ELE-40-L1-01-5T2/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                        @csrf
                                        @method('DELETE')
...
<td class="fijar">{{ $registro->criterio }}</td>
                    ...
                    <a href="{{route('checkSETCS40123C5')}}" class="btn btn-primary" id="btnIndex">Chequeo Diario</a>
                    @role('Admin')
                    <a href="F7-SETCS-ELE-40-L1-01-5T2/create" class="btn btn-success" id="btnIndex2">Añadir criterio</a>
                    <a href="{{route('pdfprintSETCS40123C5')}}" class="btn btn-danger" id="btnIndex3">Guardar PDF</a>
                    @endrole
                    <a href="/reversoSETCS40123C5" class="btn btn-secondary" id="btnIndex4">Reverso</a>                    
</body>
</html>
