...
<head>
    ...
    <title>HojasChequeo-6-8-Turno2</title>
...
<body>
    ...
    <!-- -------------- F7-SETCS-ELE-CR-L1-01-68  INDEX Y REVERSO  -------------------->
                ...
                @foreach ($registros as $registro)
                    ...
                    @if ($registro->turno == '2' &&
                        ...
                        <tr>
                            ...
                            @role('Admin')
                            <td>
                                <form action="{{route('F7-SETCS-ELE-CR-L1-01-68.destroy',$registro->id)}}" method="POST">
                                <a href="F7-SETCS-ELE-CR-L1-01-68/{{$registro->id}}/edit" class="btn btn-warning">Editar</a>
                                @csrf
                                @method('DELETE')
    ...
    hoja de chequeo F7-SETCS-ELE-20-L1-01
    <!-- -------------- F7-SETCS-ELE-20-L1-01-1T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-20-L1-01 COPIA 2
    <!-- -------------- F7-SETCS-ELE-20-L1-01-2T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-20-L1-01 COPIA 3
    <!-- -------------- F7-SETCS-ELE-20-L1-01-3T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-20-L1-03
    <!-- -------------- F7-SETCS-ELE-20-L1-03-1T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-20-L1-03 COPIA 2
    <!-- -------------- F7-SETCS-ELE-20-L1-03-2T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-01 
    <!-- -------------- F7-SETCS-ELE-40-L1-01-1T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-01 COPIA 2
    <!-- -------------- F7-SETCS-ELE-40-L1-01-2T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-01 COPIA 3
    <!-- -------------- F7-SETCS-ELE-40-L1-01-3T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-01 COPIA 4
    <!-- -------------- F7-SETCS-ELE-40-L1-01-4T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-02
    <!-- -------------- F7-SETCS-ELE-40-L1-02-1T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-02 COPIA 2
    <!-- -------------- F7-SETCS-ELE-40-L1-02-2T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-02 COPIA 3
    <!-- -------------- F7-SETCS-ELE-40-L1-02-3T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-40-L1-02 COPIA 4
    <!-- -------------- F7-SETCS-ELE-40-L1-02-4T2  INDEX Y REVERSO  -------------------->
    ...
    hoja de chequeo F7-SETCS-ELE-60-L1-01
    <!-- -------------- F7-SETCS-ELE-60-L1-01-T2  INDEX Y REVERSO  -------------------->
    ...
    <!-- -------------- F7-SETCS-ELE-60-L1-06-T2  INDEX Y REVERSO  -------------------->
