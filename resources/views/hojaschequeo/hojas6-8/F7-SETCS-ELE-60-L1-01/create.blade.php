...
<form action="/F7-SETCS-ELE-60-L1-01-T2"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
        <label for="" id=txt1 class="form-label" hidden>Criterio</label>
        <input type="text" name="criterio" id="criterio" class="form-control" tabindex="1" hidden value="-">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="turno" id="turno" class="form-control" tabindex="1" hidden value="2">
    </div>
    <div class="mb-3">
        <label for="" id=txt1 class="form-label" hidden>DocumentoID</label>
        <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1" hidden value="F7-SETCS-ELE-60-L1-01-1">
    </div>
    <div class="mb-3">
        <label for="" id="txt1" class="form-label">Parte</label>
        <select id="partetabla" name="partetabla" class="form-control" tabindex="1">
            <option value="formato">Formato de Send-Ahead</option>
            <option value="1-2-3">Primera Parte</option>
            <option value="HE1-HE2-4">Segunda Parte</option>
            <option value="5-6-HE3-HE4">Tercera Parte</option>
            <option value="7-8-9">Cuarta Parte</option>
            <option value="HE5-HE6">Quinta Parte</option>
        </select>
    </div>
    <div class="mb-3">
