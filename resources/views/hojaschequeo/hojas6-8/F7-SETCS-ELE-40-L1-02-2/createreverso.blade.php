...
<body id="vistas">
    ...
    <form action="/reversoSETCS40221C2" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        <div class="container">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="documentoid" id="documentoid" class="form-control" tabindex="1"
                    hidden value="F7-SETCS-ELE-40-L1-02-2-2">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="" style="color: white" class="form-label">Año</label>
                <input type="text" name="año" id="año" class="form-control" tabindex="1">
            </div>
            <div>
                <button type="submit" class="btn btn-primary">Guardar</button>
                <a href="/reversoSETCS40221C2" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
