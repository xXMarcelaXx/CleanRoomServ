...
<form action="/F7-SETCS-ELE-160-L1-01-2T2"id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
    @csrf
    <div class="container">
    <div class="mb-3">
    ...
    <div>
        ...
        <a href="/F7-SETCS-ELE-160-L1-01-2T2" class="btn btn-danger">Cancelar</a>
    </div>
    </div>
</form>    
</body>
