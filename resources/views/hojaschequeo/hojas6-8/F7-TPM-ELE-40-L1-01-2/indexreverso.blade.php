    ...
    <body id="vistas">
            ...
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        @endauth
                    <a href="F7-TPM-ELE-40-L1-01-2T2" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                @if ($reverso->documentoid == "F7-TPM-ELE-40-L1-01-2" && $reverso->turno == "2")
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoTPM4012T2.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoTPM4012T2/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoTPM4012T2/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoTPM4012T2')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>