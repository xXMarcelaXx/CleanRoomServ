...
<body id="vistas">
    ...
    <form action="/reversoSETCS40221C5/{{$reverso->id}}" id="loginreg" style=" height: 70%; overflow:scroll;" method="POST">
        @csrf
        @method('PUT')
        <div class="container">
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="/reversoSETCS40221C5" class="btn btn-danger">Cancelar</a>
            </div>
        </div>
    </form>
</body>
