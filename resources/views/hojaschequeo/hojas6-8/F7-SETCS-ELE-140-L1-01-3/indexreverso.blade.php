...
.fijar {
  ...
  z-index: 1;
    ...
    <body id="vistas">
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoSETCS140112C3.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoSETCS140112C3/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoSETCS140112C3/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoSETCS140112C3')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>