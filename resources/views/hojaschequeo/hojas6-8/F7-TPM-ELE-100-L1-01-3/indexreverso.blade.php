    ...
    <body id="vistas">
        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-light">
                ...
                @endauth
                    <a href="F7-TPM-ELE-100-L1-01-3T2" class="btn btn-info" style="color: white">Volver</a>
        ...
        <table class="table table-success table-bordered table-striped mt-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{route('reversoTPM10013T2.destroy',$reverso->id)}}" method="POST">
                        <a href="reversoTPM10013T2/{{$reverso->id}}/edit" style="color: white" class="btn btn-info">Editar</a>
                        @csrf
                        @method('DELETE')
        ...
        <a href="/reversoTPM10013T2/create" class="btn btn-primary">Añadir campo</a>
        @role('Admin')
        <a href="{{route('pdfReversoTPM10013T2')}}" class="btn btn-danger">Guardar PDF</a>
        @endrole
    </body>
</html>