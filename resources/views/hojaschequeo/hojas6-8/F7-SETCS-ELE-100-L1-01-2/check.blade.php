            ...
            <table class="table table-success table-bordered">
                ...
                <tbody>
                    ...
                    @foreach ($registros as $key => $registro)
                        <form action="{{ route('finalcheckSETCS100112C2', $registro->id) }}" method="POST">
                            @if (
                                $registro->turno == '2' &&
                            ...
                            <tr>
                                ...
                                @for ($i = 1; $i <= 31; $i++)
                                    <td>
                                        ...
                                        @endphp
                                        <label>
                                            <input type="radio" name="{{ $fieldName }}" id="{{ "d{$i}" }}"
                                                value="Cumple" {{ $registro->{"d{$i}"} == 'Cumple' ? 'checked' : '' }}
                                                @if ($disabled) disabled @endif> Cumple
                                        </label>
                                        <label>
                                            <input type="radio" name="{{ $fieldName }}" id="{{ "d{$i}" }}"
