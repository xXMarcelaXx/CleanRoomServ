...
@section('diseñomenus')
<br><br><br>
<h1 style="text-align: center; color:white; background-color:rgb(113, 113, 255)">hojas de chequeo turno 1</h1>
<br>
<h1 style="text-align: center; color:white; background-color:rgb(29, 29, 29)">Op. 140 Prensa OSL 111 Y OSM</h1>
<table class="table table-success table-striped mt-4">
    ...
    <tbody>
        ...
        @if($turno68->Operacion == '140'  && $turno68->Numero == 3)
        <tr>
