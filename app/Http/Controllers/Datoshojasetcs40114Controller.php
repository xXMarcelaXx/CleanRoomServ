...
class Datoshojasetcs40114Controller extends Controller
{
                /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.create');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $registros->save();
        return redirect ('/F7-SETCS-ELE-40-L1-01-1-4');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.edit')->with('registro',$registro);
    }
    public function edit2($documentoid)
    {
        $datoshoja = Datoshoja::find($documentoid);
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.edit2')->with('datoshoja',$datoshoja);
    }
    public function check(Request $request)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.check')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas)
        ->with('dia',$dia);
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-01-4.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-SETCS-ELE-40-L1-01-1-4.pdf');
    }
}
