...
use PDF;
class Reversosetcs40211Controller extends Controller
{
                        /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-02-1.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-02-1.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS40211');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-02-1.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-SETCS-ELE-40-L1-02-1.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-40-L1-02-1-1.pdf');
    }
}
