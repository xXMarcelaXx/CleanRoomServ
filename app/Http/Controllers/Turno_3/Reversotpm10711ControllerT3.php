...
use PDF;
class Reversotpm10711T3ControllerT3 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-107-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-107-L1-01.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM10711T3');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-107-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-TPM-ELE-107-L1-01.printreverso');
