...
use PDF;
class Reversosetcs18011Controllert3 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-180-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-180-L1-01.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS18013');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-180-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-180-L1-01.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-180-L1-01-T3.pdf');
    }
}