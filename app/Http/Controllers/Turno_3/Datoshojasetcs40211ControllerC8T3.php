...
class Datoshojasetcs40211ControllerC8t3 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.create');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $registros->save();
        return redirect ('/F7-SETCS-ELE-40-L1-02-8T3');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.edit')->with('registro',$registro);
    }
    public function edit2($documentoid)
    {
        $datoshoja = Datoshoja::find($documentoid);
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.edit2')->with('datoshoja',$datoshoja);
    }
    public function check(Request $request)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.check')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas)
        ->with('dia',$dia);
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-8.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-SETCS-ELE-40-L1-02-8T3.pdf');
    }
}
