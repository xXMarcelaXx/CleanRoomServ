...
class Reversosetcs20C4Controllert3 extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-20-L1-01-4.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-20-L1-01-4.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS20T3C4');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-20-L1-01-4.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-20-L1-01-4.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-20-L1-01-4.pdf');
    }
}
