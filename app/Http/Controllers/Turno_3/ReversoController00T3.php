...
use PDF;
class ReversoController00t3 extends Controller
{
    /**
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-CR-L1-01.createreverso');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-CR-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfprintReversoF7SETCSELECRL1011()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-CR-L1-01.printreverso');
