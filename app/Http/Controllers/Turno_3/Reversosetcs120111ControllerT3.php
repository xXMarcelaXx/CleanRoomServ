...
use PDF;
class Reversosetcs120111Controllert3 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-120-L1-01-1.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-120-L1-01-1.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS120113');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-120-L1-01-1.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-120-L1-01-1.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-120-L1-01-1-1.pdf');
    }
}