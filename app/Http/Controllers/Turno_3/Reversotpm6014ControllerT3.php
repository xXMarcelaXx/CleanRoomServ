...
use PDF;
class Reversotpm6014T3ControllerT3 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-4.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-4.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM6014T3');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-4.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-4.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-TPM-ELE-60-L1-01-4-1.pdf');
    }
}
