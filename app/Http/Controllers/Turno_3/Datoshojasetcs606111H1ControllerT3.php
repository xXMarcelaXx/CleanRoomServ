...
class Datoshojasetcs606111H1Controllert3 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.create');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $registros->save();
        return redirect ('/F7-SETCS-ELE-60-L1-01-T3');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.edit')->with('registro',$registro);
    }
    public function edit2($documentoid)
    {
        $datoshoja = Datoshoja::find($documentoid);
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.edit2')->with('datoshoja',$datoshoja);
    }
    public function check(Request $request)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.check')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas)
        ->with('dia',$dia);
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-60-L1-01.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-SETCS-ELE-60-L1-01-T3.pdf');
    }
}
