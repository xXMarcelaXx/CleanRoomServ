...
use PDF;
class Reversosetcs40211ControllerC5t3 extends Controller
{
                        /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-5.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-5.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS40223C5');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-5.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-02-5.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-40-L1-02-5T3.pdf');
    }
}
