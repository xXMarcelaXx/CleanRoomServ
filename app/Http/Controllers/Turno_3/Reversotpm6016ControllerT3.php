...
use PDF;
class Reversotpm6016ControllerT3 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-6.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-6.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM6016T3');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-6.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-TPM-ELE-60-L1-01-6.printreverso');
