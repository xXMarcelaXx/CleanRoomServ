...
class Reversosetcs40111C6Controllert3 extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-01-6.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-01-6.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS40111T3C6');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-01-6.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas7-3.F7-SETCS-ELE-40-L1-01-6.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-40-L1-01-6T3.pdf');
    }
}
