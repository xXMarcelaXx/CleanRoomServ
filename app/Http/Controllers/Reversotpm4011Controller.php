...
use PDF;
class Reversotpm4011Controller extends Controller
{
                               /**
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM4011');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01.printreverso');
