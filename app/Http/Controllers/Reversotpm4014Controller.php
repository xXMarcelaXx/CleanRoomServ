...
use PDF;
class Reversotpm4014Controller extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01-4.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01-4.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM4014');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01-4.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-TPM-ELE-40-L1-01-4.printreverso');
