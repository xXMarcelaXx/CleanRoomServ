...
use PDF;
class ReversoController002 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-CR-L1-01-2.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-CR-L1-01-2.createreverso');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-CR-L1-01-2.editreverso')->with('reverso',$reverso);
    }
