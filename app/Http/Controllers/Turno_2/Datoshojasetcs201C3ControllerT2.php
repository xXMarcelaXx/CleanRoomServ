...
class Datoshojasetcs201C3Controllert2 extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.create');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $registros->save();
        return redirect ('/F7-SETCS-ELE-20-L1-01-3T2');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.edit')->with('registro',$registro);
    }
    public function edit2($id)
    {
        $datoshoja = Datoshoja::find($id);
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.edit2')->with('datoshoja',$datoshoja);
    }
    public function check(Request $request)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.check')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas)
        ->with('dia',$dia);
    }
    ...
    public function update2(Request $request, $id)
    {
        ...
        $datoshojas->año = $request ->get('año');
        $datoshojas->save();
        return redirect ('/F7-SETCS-ELE-20-L1-01-2T2');
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-SETCS-ELE-20-L1-01-3T2.pdf');
    }
}
