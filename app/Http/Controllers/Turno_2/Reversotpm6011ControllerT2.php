...
use PDF;
class Reversotpm6011T2ControllerT2 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM6011T2');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01.printreverso');
