...
use PDF;
class Reversosetcs201C3Controllert2 extends Controller
{
        /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS201T2C3');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-SETCS-ELE-20-L1-01-3.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-20-L1-01-3T2.pdf');
    }
}
