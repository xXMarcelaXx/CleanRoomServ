...
use PDF;
class Reversosetcs16011Controllert2 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-160-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-160-L1-01.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS16012');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-160-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-SETCS-ELE-160-L1-01.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-160-L1-01-T2.pdf');
    }
}