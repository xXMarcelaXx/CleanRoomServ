...
class Reversosetcs606111C2Controllert2 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-60-L1-06-2.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-60-L1-06-2.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS606112C2');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-60-L1-06-2.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-SETCS-ELE-60-L1-06-2.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-60-L1-06-2T2.pdf');
    }
}
