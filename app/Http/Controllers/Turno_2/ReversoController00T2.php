...
class ReversoController00t2 extends Controller
{
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01.createreverso');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfprintReversoF7SETCSELECRL1011()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01.printreverso');
