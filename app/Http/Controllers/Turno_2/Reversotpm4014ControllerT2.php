...
use PDF;
class Reversotpm4014T2Controllert2 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-40-L1-01-4.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-40-L1-01-4.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM4014T2');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-40-L1-01-4.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-TPM-ELE-40-L1-01-4.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-TPM-ELE-40-L1-01-4-1.pdf');
    }
}
