...
use PDF;
class Reversotpm120131T2ControllerT2 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-120-L1-01-3.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-120-L1-01-3.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM120131T2');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-120-L1-01-3.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-TPM-ELE-120-L1-01-3.printreverso');
