...
use PDF;
class Reversotpm6013T2ControllerT2 extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01-3.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01-3.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM6013T2');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01-3.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-TPM-ELE-60-L1-01-3.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-TPM-ELE-60-L1-01-3-1.pdf');
    }
}
