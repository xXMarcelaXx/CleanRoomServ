...
class Datoshojastpm10712ControllerT2 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.create');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        $registros->save();
        return redirect ('/F7-TPM-ELE-107-L1-01-2T2');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.edit')->with('registro',$registro);
    }
    public function edit2($documentoid)
    {
        $datoshoja = Datoshoja::find($documentoid);
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.edit2')->with('datoshoja',$datoshoja);
    }
    public function check(Request $request)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.check')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas)
        ->with('dia',$dia);
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-TPM-ELE-107-L1-01-2.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-TPM-ELE-107-L1-01-2.pdf');
    }
}
