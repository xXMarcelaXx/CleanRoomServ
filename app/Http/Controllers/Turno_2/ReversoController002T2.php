...
use PDF;
class ReversoController002t2 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01-2.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01-2.createreverso');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01-2.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfprintReversoF7SETCSELECRL1011()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas6-8.F7-SETCS-ELE-CR-L1-01-2.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-CR-L1-01-T2.pdf');
    }
}
