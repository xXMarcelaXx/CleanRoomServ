...
class Datoshojasetcs201ControllerC3 extends Controller
{
        /**
    ...
    {        
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-3.index')
    ...
    public function printindex()
    {
        $registros = Registro::all();
        $datoshojas = Datoshoja::all();
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-3.printindex')
        ->with('registros',$registros)
        ->with('datoshojas',$datoshojas);
    }
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-3.create');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-3.edit')->with('registro',$registro);
    }
    public function edit2($id)
    {
        $datoshoja = Datoshoja::find($id);
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-3.edit2')->with('datoshoja',$datoshoja);
    }
    ...
    public function pdfprint()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-3.printindex');
        $pdf->setPaper('b3','landscape');
        return $pdf-> download('F7-SETCS-ELE-20-L1-01-2-1C3.pdf');
    }
}
