...
class Reversosetcs606111H1Controllert1 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-01.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-01.createreverso');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-01.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-01.printreverso');
