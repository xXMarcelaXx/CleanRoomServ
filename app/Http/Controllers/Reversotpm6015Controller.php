...
use PDF;
class Reversotpm6015Controller extends Controller
{
                               /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-60-L1-01-5.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-60-L1-01-5.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoTPM6015');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-TPM-ELE-60-L1-01-5.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-TPM-ELE-60-L1-01-5.printreverso');
