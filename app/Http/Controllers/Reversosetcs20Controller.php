...
class Reversosetcs20Controller extends Controller
{
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-1.createreverso');
    }
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-20-L1-01-1.editreverso')->with('reverso',$reverso);
    }
