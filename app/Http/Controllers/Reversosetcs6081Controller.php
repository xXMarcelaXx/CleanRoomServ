...
class Reversosetcs6081Controller extends Controller
{
            /**
    ...
    public function index()
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-08.indexreverso')
    ...
    {
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-08.createreverso');
    }
    ...
    public function store(Request $request)
    {
        ...
        $reversos->save();
        return redirect('/reversoSETCS6081');
    }
    /**
    ...
    public function edit($id)
    {
        ...
        return view('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-08.editreverso')->with('reverso',$reverso);
    }
    ...
    public function pdfReverso()
    {
        ...
        $pdf = PDF::loadView('hojaschequeo.hojas5-7.F7-SETCS-ELE-60-L1-08.printreverso');
        $pdf->setPaper('b4','landscape');
        return $pdf-> download('Reverso-F7-SETCS-ELE-60-L1-08-1.pdf');
    }
}
